...
public class ThirdPersonOrbitCam : MonoBehaviour 
{
	...
	void LateUpdate()
	{
		...
		angleH += Mathf.Clamp(Input.GetAxis("Axis 4"), -1, 1) * horizontalAimingSpeed * Time.deltaTime;
		angleV += Mathf.Clamp(Input.GetAxis("Axis 5"), -1, 1) * verticalAimingSpeed * Time.deltaTime;
